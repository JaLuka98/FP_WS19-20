...
Der Landé-Faktor kann mithilfe von Formel \eqref{eqn:B_M_Theorie} berechnet werden zu
\begin{equation*}
...
\end{align*}
wobei die Unsicherheiten durch den zweiten Term in \eqref{eqn:sigma_Delta_E_Z} beschrieben werden.
